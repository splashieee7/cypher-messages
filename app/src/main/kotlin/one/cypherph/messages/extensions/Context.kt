package one.cypherph.messages.extensions
...
import one.cypherph.messages.databases.MessagesDatabase
import one.cypherph.messages.helpers.AttachmentUtils.parseAttachmentNames
import one.cypherph.messages.helpers.Config
import one.cypherph.messages.helpers.FILE_SIZE_NONE
import one.cypherph.messages.helpers.MAX_MESSAGE_LENGTH
import one.cypherph.messages.helpers.MESSAGES_LIMIT
import one.cypherph.messages.helpers.MessagingCache
import one.cypherph.messages.helpers.NotificationHelper
import one.cypherph.messages.helpers.ShortcutHelper
import one.cypherph.messages.helpers.generateRandomId
import one.cypherph.messages.interfaces.AttachmentsDao
import one.cypherph.messages.interfaces.ConversationsDao
import one.cypherph.messages.interfaces.DraftsDao
import one.cypherph.messages.interfaces.MessageAttachmentsDao
import one.cypherph.messages.interfaces.MessagesDao
import one.cypherph.messages.messaging.MessagingUtils
import one.cypherph.messages.messaging.MessagingUtils.Companion.ADDRESS_SEPARATOR
import one.cypherph.messages.messaging.SmsSender
...
import one.cypherph.messages.models.Draft
import one.cypherph.messages.models.Message
import one.cypherph.messages.models.MessageAttachment
import one.cypherph.messages.models.NamePhoto
import one.cypherph.messages.models.RecycleBinMessage
