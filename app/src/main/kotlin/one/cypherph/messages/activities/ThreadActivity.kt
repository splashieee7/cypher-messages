...
import one.cypherph.messages.BuildConfig
import one.cypherph.messages.R
import one.cypherph.messages.adapters.AttachmentsAdapter
import one.cypherph.messages.adapters.AutoCompleteTextViewAdapter
import one.cypherph.messages.adapters.ThreadAdapter
import one.cypherph.messages.databinding.ActivityThreadBinding
import one.cypherph.messages.databinding.ItemSelectedContactBinding
import one.cypherph.messages.dialogs.GroupMessageSendDialog
import one.cypherph.messages.dialogs.InvalidNumberDialog
import one.cypherph.messages.dialogs.RenameConversationDialog
import one.cypherph.messages.dialogs.ScheduleMessageDialog
import one.cypherph.messages.extensions.clearExpiredScheduledMessages
import one.cypherph.messages.extensions.config
import one.cypherph.messages.extensions.conversationsDB
import one.cypherph.messages.extensions.copyToUri
import one.cypherph.messages.extensions.createTemporaryThread
import one.cypherph.messages.extensions.deleteConversation
import one.cypherph.messages.extensions.deleteMessage
import one.cypherph.messages.extensions.deleteScheduledMessage
import one.cypherph.messages.extensions.deleteSmsDraft
import one.cypherph.messages.extensions.dialNumber
import one.cypherph.messages.extensions.emptyMessagesRecycleBinForConversation
import one.cypherph.messages.extensions.filterNotInByKey
import one.cypherph.messages.extensions.getAddresses
import one.cypherph.messages.extensions.getDefaultKeyboardHeight
import one.cypherph.messages.extensions.getFileSizeFromUri
import one.cypherph.messages.extensions.getMessages
import one.cypherph.messages.extensions.getSmsDraft
import one.cypherph.messages.extensions.getThreadId
import one.cypherph.messages.extensions.getThreadParticipants
import one.cypherph.messages.extensions.getThreadTitle
import one.cypherph.messages.extensions.indexOfFirstOrNull
import one.cypherph.messages.extensions.isGifMimeType
import one.cypherph.messages.extensions.isImageMimeType
import one.cypherph.messages.extensions.launchConversationDetails
import one.cypherph.messages.extensions.markMessageRead
import one.cypherph.messages.extensions.markThreadMessagesRead
import one.cypherph.messages.extensions.markThreadMessagesUnread
import one.cypherph.messages.extensions.messagesDB
import one.cypherph.messages.extensions.moveMessageToRecycleBin
import one.cypherph.messages.extensions.onScroll
import one.cypherph.messages.extensions.removeDiacriticsIfNeeded
import one.cypherph.messages.extensions.renameConversation
import one.cypherph.messages.extensions.restoreAllMessagesFromRecycleBinForConversation
import one.cypherph.messages.extensions.restoreMessageFromRecycleBin
import one.cypherph.messages.extensions.saveSmsDraft
import one.cypherph.messages.extensions.shouldUnarchive
import one.cypherph.messages.extensions.showWithAnimation
import one.cypherph.messages.extensions.subscriptionManagerCompat
import one.cypherph.messages.extensions.toArrayList
import one.cypherph.messages.extensions.toSortedMessages
...
import one.cypherph.messages.extensions.updateScheduledMessagesThreadId
import one.cypherph.messages.helpers.CAPTURE_AUDIO_INTENT
import one.cypherph.messages.helpers.CAPTURE_PHOTO_INTENT
import one.cypherph.messages.helpers.CAPTURE_VIDEO_INTENT
import one.cypherph.messages.helpers.FILE_SIZE_NONE
import one.cypherph.messages.helpers.IS_LAUNCHED_FROM_SHORTCUT
import one.cypherph.messages.helpers.IS_RECYCLE_BIN
import one.cypherph.messages.helpers.MESSAGES_LIMIT
import one.cypherph.messages.helpers.PICK_CONTACT_INTENT
import one.cypherph.messages.helpers.PICK_DOCUMENT_INTENT
import one.cypherph.messages.helpers.PICK_PHOTO_INTENT
import one.cypherph.messages.helpers.PICK_SAVE_DIR_INTENT
import one.cypherph.messages.helpers.PICK_SAVE_FILE_INTENT
import one.cypherph.messages.helpers.PICK_VIDEO_INTENT
import one.cypherph.messages.helpers.SEARCHED_MESSAGE_ID
import one.cypherph.messages.helpers.THREAD_ATTACHMENT_URI
import one.cypherph.messages.helpers.THREAD_ATTACHMENT_URIS
import one.cypherph.messages.helpers.THREAD_ID
import one.cypherph.messages.helpers.THREAD_NUMBER
import one.cypherph.messages.helpers.THREAD_TEXT
import one.cypherph.messages.helpers.THREAD_TITLE
import one.cypherph.messages.helpers.generateRandomId
import one.cypherph.messages.helpers.refreshConversations
import one.cypherph.messages.helpers.refreshMessages
import one.cypherph.messages.messaging.cancelScheduleSendPendingIntent
import one.cypherph.messages.messaging.isLongMmsMessage
import one.cypherph.messages.messaging.isShortCodeWithLetters
import one.cypherph.messages.messaging.scheduleMessage
import one.cypherph.messages.messaging.sendMessageCompat
import one.cypherph.messages.models.Attachment
import one.cypherph.messages.models.AttachmentSelection
import one.cypherph.messages.models.Conversation
import one.cypherph.messages.models.Events
import one.cypherph.messages.models.Message
import one.cypherph.messages.models.MessageAttachment
import one.cypherph.messages.models.SIMCard
import one.cypherph.messages.models.ThreadItem
import one.cypherph.messages.models.ThreadItem.ThreadDateTime
import one.cypherph.messages.models.ThreadItem.ThreadError
import one.cypherph.messages.models.ThreadItem.ThreadSending
import one.cypherph.messages.models.ThreadItem.ThreadSent
