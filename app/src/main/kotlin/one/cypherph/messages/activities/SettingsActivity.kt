...
import one.cypherph.messages.databinding.ActivitySettingsBinding
import one.cypherph.messages.dialogs.ExportMessagesDialog
import one.cypherph.messages.extensions.config
import one.cypherph.messages.extensions.emptyMessagesRecycleBin
import one.cypherph.messages.extensions.messagesDB
import one.cypherph.messages.helpers.FILE_SIZE_100_KB
import one.cypherph.messages.helpers.FILE_SIZE_1_MB
import one.cypherph.messages.helpers.FILE_SIZE_200_KB
import one.cypherph.messages.helpers.FILE_SIZE_2_MB
import one.cypherph.messages.helpers.FILE_SIZE_300_KB
import one.cypherph.messages.helpers.FILE_SIZE_600_KB
import one.cypherph.messages.helpers.FILE_SIZE_NONE
import one.cypherph.messages.helpers.LOCK_SCREEN_NOTHING
import one.cypherph.messages.helpers.LOCK_SCREEN_SENDER
import one.cypherph.messages.helpers.LOCK_SCREEN_SENDER_MESSAGE
