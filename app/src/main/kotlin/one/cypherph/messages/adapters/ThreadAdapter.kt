package one.cypherph.messages.adapters
...
import one.cypherph.messages.activities.NewConversationActivity
import one.cypherph.messages.activities.SimpleActivity
import one.cypherph.messages.activities.ThreadActivity
import one.cypherph.messages.activities.VCardViewerActivity
import one.cypherph.messages.databinding.ItemAttachmentDocumentBinding
import one.cypherph.messages.databinding.ItemAttachmentImageBinding
import one.cypherph.messages.databinding.ItemAttachmentVcardBinding
import one.cypherph.messages.databinding.ItemMessageBinding
import one.cypherph.messages.databinding.ItemThreadDateTimeBinding
import one.cypherph.messages.databinding.ItemThreadErrorBinding
import one.cypherph.messages.databinding.ItemThreadSendingBinding
import one.cypherph.messages.databinding.ItemThreadSuccessBinding
import one.cypherph.messages.dialogs.DeleteConfirmationDialog
import one.cypherph.messages.dialogs.MessageDetailsDialog
import one.cypherph.messages.dialogs.SelectTextDialog
import one.cypherph.messages.extensions.config
import one.cypherph.messages.extensions.getContactFromAddress
import one.cypherph.messages.extensions.isImageMimeType
import one.cypherph.messages.extensions.isVCardMimeType
import one.cypherph.messages.extensions.isVideoMimeType
import one.cypherph.messages.extensions.launchViewIntent
import one.cypherph.messages.extensions.startContactDetailsIntent
import one.cypherph.messages.extensions.subscriptionManagerCompat
import one.cypherph.messages.helpers.EXTRA_VCARD_URI
import one.cypherph.messages.helpers.THREAD_DATE_TIME
import one.cypherph.messages.helpers.THREAD_RECEIVED_MESSAGE
import one.cypherph.messages.helpers.THREAD_SENT_MESSAGE
import one.cypherph.messages.helpers.THREAD_SENT_MESSAGE_ERROR
import one.cypherph.messages.helpers.THREAD_SENT_MESSAGE_SENDING
import one.cypherph.messages.helpers.THREAD_SENT_MESSAGE_SENT
import one.cypherph.messages.helpers.generateStableId
import one.cypherph.messages.helpers.setupDocumentPreview
import one.cypherph.messages.helpers.setupVCardPreview
