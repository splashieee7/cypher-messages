...
class Config(context: Context) : BaseConfig(context) {
    ...
    /**
     * Commons enables the Material You / system palette by default on Android 12+,
     * which would override the bundled Cypher palette. Only opt out when the user
     * has never touched the setting, so their own choice is always respected.
     */
    fun applyCypherThemeDefaults() {
